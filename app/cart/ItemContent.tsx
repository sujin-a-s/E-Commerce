...
const ItemContent: React.FC<ItemContentProps> = ({item}) => {
    ...
    return ( 
        <div className="grid grid-cols-5 text-xs md:text-sm gap-4 border-t-[1.5px] border-slate-50-200 py-4 items-center">
            ...
            <div className="justify-self-center"><SetQuantity cartCounter cartProduct={item} handleQtyIncrease={()=>{handleCartQtyIncrease(item)}} handleQtyDecrease={()=>{handleCartQtyDecrease(item)}}/></div>
